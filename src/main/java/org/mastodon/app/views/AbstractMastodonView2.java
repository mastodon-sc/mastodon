		...
		E extends Edge< V > > implements MastodonView2
{
	...
	protected final GraphColorGeneratorAdapter< MV, ME, V, E > coloringAdapter;
			...
			final VG viewGraph )
	{
		...
		// Coloring adapter.
		this.coloringAdapter = new GraphColorGeneratorAdapter<>( viewGraph.getVertexMap(), viewGraph.getEdgeMap() );
