...
class LauncherGUI extends JPanel
{
	...
	private static final ImageIcon NEW_MASTODON_ICON = new ImageIcon( MastodonLauncher.class.getResource( "Mastodon-logo-01-32x32.png" ) );

	private static final ImageIcon LOAD_MASTODON_ICON = new ImageIcon( MastodonLauncher.class.getResource( "Mastodon-load-01-32x32.png" ) );

	private static final ImageIcon IMPORT_TGMM_ICON = new ImageIcon( MastodonLauncher.class.getResource( "TGMM-logo-32x32.png" ) );

	private static final ImageIcon IMPORT_MAMUT_ICON = new ImageIcon( MastodonLauncher.class.getResource( "MaMuT-logo-32x32.png" ) );

	private static final ImageIcon IMPORT_SIMI_ICON = new ImageIcon( MastodonLauncher.class.getResource( "SimiBioCell-green-logo-32x32.png" ) );

	private static final ImageIcon HELP_ICON = new ImageIcon( MastodonLauncher.class.getResource( "help.png" ) );
	...
	public LauncherGUI()
	{
		...
		btnNew = new JButton( NEW_MASTODON_ICON );
		...
		c.gridx = 0;
		c.gridy++;
		btnLoad = new JButton( LOAD_MASTODON_ICON );
		...
		c.gridy++;
		c.gridwidth = 1;
		btnImportTgmm = new JButton( IMPORT_TGMM_ICON );
		...
		c.gridx = 0;
		c.gridy++;
		btnImportMamut = new JButton( IMPORT_MAMUT_ICON );
		...
		c.gridx = 0;
		c.gridy++;
		btnImportSimi = new JButton( IMPORT_SIMI_ICON );
