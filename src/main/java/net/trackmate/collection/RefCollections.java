...
import net.trackmate.collection.wrap.RefDequeWrapper;
import net.trackmate.collection.wrap.RefListWrapper;
import net.trackmate.collection.wrap.RefMapWrapper;
import net.trackmate.collection.wrap.RefSetWrapper;
import net.trackmate.collection.wrap.RefStackWrapper;
