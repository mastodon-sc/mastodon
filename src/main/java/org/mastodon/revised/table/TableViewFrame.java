		...
		ContextListener< V >
{
			...
			final UndoPointMarker undoPointMarker )
	{
		...
		final Set< Feature< V, ? > > vertexFeatures = featureModel.getFeatureSet( vertexClass );
		...
		final Set< Feature< E, ? > > edgeFeatures = featureModel.getFeatureSet( edgeClass );
	...
	public void featureModelChanged()
	{
		ignoreTableSelectionChange = true;
		@SuppressWarnings( "unchecked" )
		final Set< Feature< V, ? > > vertexFeatures = featureModel.getFeatureSet( ( Class< V > ) vref.getClass() );
		vertexTable.setFeatures( vertexFeatures );
		@SuppressWarnings( "unchecked" )
		final Set< Feature< E, ? > > edgeFeatures = featureModel.getFeatureSet( ( Class< E > ) eref.getClass() );
		edgeTable.setFeatures( edgeFeatures );
		if ( mirrorSelection )
			selectionChanged();
		ignoreTableSelectionChange = false;
