...
public class DepthFirstSearchUndirectedTest
{
	...
	public void testForkPoolObjects()
	{
		...
		final DepthFirstSearch< TestVertex, TestEdge > dfs = new DepthFirstSearch< TestVertex, TestEdge >( bundle.graph, false );
	...
	public void testForkStdObjects()
	{
		...
		final List< EdgeClass > edgeClass = Arrays.asList( new EdgeClass[] { TREE, TREE } );
		final List< ObjectVertex< Integer >> processedVertices = new ArrayList< ObjectVertex< Integer > >( 3 );
	...
	public void testLoopStdObjects()
	{
		...
		/**
		 * Interestingly, the std object graph returns the other order for equal
		 * vertices.
		 */
	...
	public void testExampleStdObjects()
	{
		...
		dfs.setTraversalListener( traversalTester );
//		dfs.setTraversalListener( GraphsForTests.traversalPrinter( bundle.graph ) );
		dfs.start( first );
		traversalTester.searchDone();
	}
