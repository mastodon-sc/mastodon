 ...
 */
public class ListenableGraphWrapper< V extends Vertex< E >, E extends Edge< V >, G extends Graph< V, E > > implements Graph< V, E >, ListenableGraph< V, E >, CollectionCreator< V, E >
{
	/*
	 * STATIC ACCESSOR
	 */
