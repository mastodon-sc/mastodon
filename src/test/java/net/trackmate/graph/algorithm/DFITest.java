...
public class DFITest
{
	...
	{
		final DFI< TrackSchemeVertex, TrackSchemeEdge > dfi = new DFI< TrackSchemeVertex, TrackSchemeEdge >( A, graph );

		assertTrue( "After initiation, DFI always has next. Got false.", dfi.hasNext() );
	...
	public static void main( final String[] args )
	{
		...
		final DFI< TrackSchemeVertex, TrackSchemeEdge > iterator = new DFI< TrackSchemeVertex, TrackSchemeEdge >( test.A, test.graph );
