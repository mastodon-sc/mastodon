...
public class FeatureColorModeEditorPanel extends JPanel
{
	...
	private static < T > boolean isFeatureKeyIn( final FeatureModel featureModel, final String featureKey, final Class< T > clazz )
	{
	 ...
	 */
	private static < T > Collection< String > collectKeys( final Set< Feature< T, ? > > featureSet )
	{
		if ( featureSet == null )
