...
public class FeatureColorMode implements Style< FeatureColorMode >
{
	...
	private static final FeatureColorMode EMPTY;
	static
	{
		EMPTY = new FeatureColorMode();
		EMPTY.name = "No coloring";
		EMPTY.vertexColorMode = VertexColorMode.NONE;
		EMPTY.vertexColorMap = ColorMap.VIRIDIS.getName();
		EMPTY.vertexFeatureProjection = new String[] { LinkVelocityFeatureComputer.KEY, LinkVelocityFeatureComputer.KEY };
		EMPTY.vertexRangeMin = 0.;
		EMPTY.vertexRangeMax = 1.;
		EMPTY.edgeColorMode = EdgeColorMode.NONE;
		EMPTY.edgeColorMap = EMPTY.vertexColorMap;
		EMPTY.edgeFeatureProjection = EMPTY.vertexFeatureProjection;
		EMPTY.edgeRangeMin = EMPTY.vertexRangeMin;
		EMPTY.edgeRangeMax = EMPTY.vertexRangeMax;
	}
